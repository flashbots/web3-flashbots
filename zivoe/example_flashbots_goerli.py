...
def main() -> None:
    ...
    sender: LocalAccount = Account.from_key(env("KEEPER_0_PK"))

    # account to receive the transfer
    receiverAddress: str = "0x3E644B1E792E334EA518FA1115D5D62A70cbf5fE"

    # account to sign bundles & establish flashbots reputation
    # NOTE: this account should not store funds
    signer: LocalAccount = Account.from_key(env("KEEPER_0_PK"))

    w3 = Web3(HTTPProvider(env("INFURA_RPC_GOERLI")))
